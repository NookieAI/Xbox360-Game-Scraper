<div align="center">
<img width="960" alt="Xbox 360 Game Browser — library view" src=".github/screenshots/library.png" />

# 🎮 Xbox 360 Game Browser

**Browse, search, and download from a huge Xbox 360 game library — all from one clean desktop app.**

[![Latest Release](https://img.shields.io/github/v/release/NookieAI/Xbox360-Game-Scraper?label=latest&color=1de02d&style=for-the-badge)](https://github.com/NookieAI/Xbox360-Game-Scraper/releases/latest)
[![Downloads](https://img.shields.io/github/downloads/NookieAI/Xbox360-Game-Scraper/total?color=1de02d&style=for-the-badge)](https://github.com/NookieAI/Xbox360-Game-Scraper/releases)
[![Platforms](https://img.shields.io/badge/platforms-Windows%20%7C%20macOS%20%7C%20Linux-1de02d?style=for-the-badge)](#-install)
...
Grab the right file for your computer from the **[Latest Release](https://github.com/NookieAI/Xbox360-Game-Scraper/releases/latest)** page:

| Your computer | Download |
|---|---|
| 🪟 **Windows 10/11** | `Xbox 360 Game Browser v*.exe` — *portable, just double-click* |
| 🍎 **Mac (Apple Silicon — M1/M2/M3/M4)** | `Xbox 360 Game Browser v*_aarch64.app.zip` |
| 🍎 **Mac (Intel)** | `Xbox 360 Game Browser v*_x64.app.zip` |
| 🐧 **Linux (any)** | `Xbox 360 Game Browser v*_amd64.AppImage` — *portable, just chmod +x* |
...
- 🆕 **Newest first** by default — see what just got added without scrolling
- 🎨 **Cover art and full game info** — developer, publisher, region, file size, release date
- ⏱️ **"How Long to Beat" stats** built right into every game's page
- 🔗 **Multiple download mirrors** for every game — pick the host you prefer
...
1. Download `Xbox 360 Game Browser v*.exe` from the [releases page](https://github.com/NookieAI/Xbox360-Game-Scraper/releases/latest).
...
2. Double-click the `.zip` to unzip — you'll get **Xbox 360 Game Browser.app**.
3. Put it anywhere you want — Applications, Desktop, an external drive. Then double-click to open.
4. The first time you open it: macOS will refuse and say *"Xbox 360 Game Browser can't be opened because Apple cannot check it for malicious software."* This is normal for apps not sold through the App Store.
...
1. Download `Xbox 360 Game Browser v*_amd64.AppImage`.
2. Right-click it → Properties → make it executable.  
   *(Or in a terminal: `chmod +x "Xbox 360 Game Browser"*.AppImage`)*
...
- If one's available, it downloads quietly in the background, then the app briefly restarts on the new version. Takes about 30 seconds.
...
- If nothing happens after an update starts, your antivirus may be blocking it. Temporarily disable it and try again, or download manually from the [releases page](https://github.com/NookieAI/Xbox360-Game-Scraper/releases/latest).
</details>
...
- **Mac:** drag Xbox 360 Game Browser.app to the Trash.
- **Linux:** delete the .AppImage file.

If you want to clear remembered settings too: delete the small config folder the app stores in your user data folder (`%APPDATA%\com.nookie.xbox360browser\` on Windows, `~/Library/Application Support/com.nookie.xbox360browser/` on Mac, `~/.local/share/com.nookie.xbox360browser/` on Linux).
</details>
...
Open an [Issue](https://github.com/NookieAI/Xbox360-Game-Scraper/issues) and describe what happened. Screenshots help a lot.
